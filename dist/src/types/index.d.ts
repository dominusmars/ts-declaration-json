...
export type PropertyDeclaration = ArrayDeclaration | TupleDeclaration | NumberDeclaration | BooleanDeclaration | StringDeclaration | UnknownDeclaration | FunctionDeclaration | Implementation | string;
